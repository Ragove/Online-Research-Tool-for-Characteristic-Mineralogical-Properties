...
if ($conn->connect_error) {
  ...
  $sql = "SELECT * FROM mineralhome JOIN physical ON mineralhome.Mineral_id = physical.Mineral_id WHERE physical.hardness = '$_POST[hardness]';";

  $result = mysqli_query($conn, $sql);
  $resultCheck = mysqli_num_rows($result);
  if ($resultCheck > 0){
	  echo "<table>"; 
	  echo "<tr><th>ID</th><th>Name</th><th>Description</th><th>Luster</th><th>Streak</th><th>Hardness</th><th>Tenacity</th><th>Cleavage</th><th>Fracture</th><th>Density</th></tr>";
